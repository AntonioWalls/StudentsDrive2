"""
Django settings for MyDjangoProject_Server project.
...
SECRET_KEY = 'django-insecure--vrwbz$w^)ffs_@$_)cjzkx2lglzr86kqr8t=%#@p(zm&7l*ix'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['192.168.1.11'] #Dirección IP que puede cambiar en el proyecto cada que reinicia la computadora
...
ROOT_URLCONF = 'MyDjangoProject_Server.urls'
